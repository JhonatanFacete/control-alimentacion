...
$(function(){
     ...
     * Inicia una serie de devoluciones de llamada en el tamaño del acelerador.
    ...
    SingAppView.prototype._initOnScreenSizeCallbacks = function(){
        ...
        $(window).resize(function() {
            ...
            resizeTimeout = setTimeout(function(){
                ...
                if (size != prevSize){ //correr solo si algo cambia


                    //Ejecutar primero las devoluciones de llamada de salidat
     ...
     * Contrae la navegación si la opción de almacenamiento local nav-static está configurada en falso
     ...
     * Expande o colapsa la navegación. Válido solo para colapsar el estado de navegación.
    ...
    SingAppView.prototype.collapseNavigation = function(){
        ...
        //Este método solo tiene sentido para el estado de navegación no estática.
     ...
     * Alterna entre estados de navegación estáticos y colapsados.


     * Colapso: la navegación se contrae automáticamente cuando el ratón lo deja y se expande cuando entra.


     * Estático - permanece siempre abierto.
     ...
     *  Activa el estado de navegación en colapso.


     * Estado de navegación colapsado: la navegación se contrae automáticamente cuando el mouse lo deja y se expande cuando entra.


     *Estado de navegación estático - la navegación permanece siempre abierta
     ...
     * Cambia el elemento de navegación activo dependiendo de la página actual.
    ...
    SingAppView.prototype._changeActiveNavigationItem = function(event, xhr, options){
        ...
        var $newActiveLink = this.$sidebar.find('a[href*="' + this.extractPageName(options.url) + '"]').filter(function(){
			...
			SingApp.onPageLoad(pageLoad);// Prueba - ERROR
     ...
     * Especifique una función para ejecutar cuando una página fue recargada con pjax.
...
function initAppPlugins(){
     ...
     * Ajax Cargar enlaces, botones y entradas.


     * carga # data-ajax-target desde url proporcionado en data-ajax-load
